      ...
      <div class="col-10">
        <div class="card-header col-12">
          <div class="row justify-content-around bg-white">
            ...
            <button class="border border-white bg-white" @click="localClear">
              <img
          ...
          <div class="col-12">
            <div class="card my-3 class=center-block" style="float: none">
              <div class="card-body mx-auto">
                <div class="btn-info rounded p-3" style="cursor: default">
                  <button class="rounded p-2" style="cursor: default">
                    <span class="m-3 font-weight-bold"
                      >ATTENTION !!!<br />si vous supprimez votre compte,
                      l'ensemble de vos messages et images seront supprimés.<br />Cette
                      suppression sera irréversible.</span
                    >
                  </button>
                </div>
              </div>
              <div class="card-body mx-auto">
                <div class="btn-danger rounded p-3" style="cursor: default">
                  <button
                    @click="deleteMyAccount(id)"
                    class="rounded p-2 bg-light"
                  >
                    <span class="m-3 font-weight-bold"
